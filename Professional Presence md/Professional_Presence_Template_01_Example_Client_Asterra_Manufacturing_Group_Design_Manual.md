...
Asterra should feel **industrial, established, precise, confident, and forward-looking**. The design uses a restrained dark blue foundation, warm copper accent, strong editorial typography, large documentary photography, and disciplined grid alignment. Authority comes from scale, evidence, production imagery, leadership, and clear information hierarchy rather than visual decoration.
...
colors:
  ...
  primary-hover: "#12334F"
  primary-active: "#071522"
  primary-disabled: "#7B8995"
  secondary: "#2F4657"         # Steel blue
  accent: "#B66A35"            # Copper
  accent-hover: "#98582C"
  ink: "#14202A"
  body: "#35414A"
  muted: "#69757D"
  ...
  elevated: "#FFFFFF"
  border: "#D9DDE0"
  strong-border: "#B7C0C6"
  success: "#2F6B4F"
  warning: "#A86D23"
  error: "#A63D32"
  info: "#2E5F83"
  overlay: "rgba(11,31,51,0.58)"
```
...
- **20%** navy and dark corporate sections
- **10%** copper accent and supporting emphasis

### Rules

- Navy is the main authority color.
- Copper is an accent, not a second dominant color.
- Copper should identify important actions, highlights, and selected emphasis.
- Do not place copper behind large amounts of body text.
- Use warm neutral backgrounds instead of pure white everywhere to create a more editorial feel.
- Dark navy sections should be used as deliberate visual chapters.
...
**Inter Tight** — chosen for a compact, professional corporate interface and strong numeric readability.

## Display font
**Manrope** — used selectively for major corporate statements and large headings.
...
- Navy text.
- Copper used for active/primary action emphasis.
...
- Image-led hero.
- Deep navy overlay if text sits on image.
- Copper eyebrow or CTA accent.
- Large typography.
...
8. Use authentic-looking industrial imagery only as placeholder art direction; final assets must be approved.
...
- [ ] Navy, copper, and neutral colors create the intended authority hierarchy.
